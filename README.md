*This repository is a mirror of the [component](http://component.io) module [richthegeek/select2](http://github.com/richthegeek/select2). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/richthegeek-select2`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
Select2
=================
